...
class ReportTimeTableTeacherGenerate(models.AbstractModel):
    _inherit = 'report.openeducat_timetable.report_timetable_teacher_generate'
    ...
    def get_object(self, data):
        get = super(ReportTimeTableTeacherGenerate, self).get_object(data)
        data_list = []
        for timetable_obj in self.env['op.session'].browse(
            ...
            timetable_data = {
                ...
                'year': timetable_obj.year_id.name,
